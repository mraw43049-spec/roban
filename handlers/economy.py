...
async def games(call: CallbackQuery):
    await call.message.answer(
        ...
        "🐾 <b>بازی‌های گروهی روبی</b> 🦊 (از لول ۲ به بعد)\nداخل هر گروه بنویس «بازی روبی» تا بازی‌های دو تا چهار نفره با شرط‌بندی روب پوینت باز بشه: XO، سنگ‌کاغذقیچی، دارت، بسکتبال، بولینگ.",
        reply_markup=back_menu()
    )
    await call.answer()
